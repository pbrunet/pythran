...
MODULES = {
    "__builtin__": {
        ...
        "enumerate": ReadOnceFunctionIntr(type=lambda: [md.TFun([[md.TIterable(md.get_random_name(),
                                                                            md.TTuple(md.get_random_name(), md.TLong(), md.TVar(v))),
        ...
        "float_": ClassWithConstConstructor(CLASSES['float'], type=lambda: md.TFun([[md.TFloat(), md.TVar(md.get_random_name())]])),
        "getattr": ConstFunctionIntr( type=lambda: md.TFun([[md.TLong,
                                                           md.TArray(md.get_random_name(), md.TLong), md.TLong]])),
        "hex": ConstFunctionIntr(),
        "id": ConstFunctionIntr(),
        "int_": ConstFunctionIntr(type=lambda: md.TFun([[md.TLong(), md.TVar(md.get_random_name())]])),
        "iter": FunctionIntr(),  # not const
        "len": ConstFunctionIntr(return_range=prange.positive_values,
                                 type=lambda: md.TFun([[md.TLong(), md.TList(md.get_random_name(), md.TVar(md.get_random_name()))]])),
        ...
        "xrange": ConstFunctionIntr(return_range_content=prange.range_values,
                                    type=lambda: md.TFun([[md.TIterable(md.get_random_name(), md.TLong()),
                                                md.TLong(), md.TLong(), md.TLong()]])),
    ...
    "numpy": {
        ...
        "float_": ConstFunctionIntr(type=lambda: md.TFun([[md.TFloat(), md.TVar(md.get_random_name())]])),
