...
MODULES = {
    "__builtin__": {
        ...
        "enumerate": ReadOnceFunctionIntr(type=lambda: [md.TFun([[md.TIterable(md.get_random_name(),
                                                                               md.TTuple(md.get_random_name(), md.TLong(md.get_random_name()), md.TVar(v))),
                                                                  md.TIterable(md.get_random_name(), md.TVar(v))]])
                                                        for v in [md.get_random_name()]][0]),
        "file": ClassWithConstConstructor(CLASSES['file']),
        "filter": ReadOnceFunctionIntr(),
        "float_": ClassWithConstConstructor(CLASSES['float'], type=lambda: md.TFun([[md.TFloat(md.get_random_name()), md.TVar(md.get_random_name())]])),
        "getattr": ConstFunctionIntr( type=lambda: md.TFun([[md.TLong(md.get_random_name()),
                                                           md.TArray(md.get_random_name(), md.TLong(md.get_random_name())), md.TLong(md.get_random_name())]])),
        "hex": ConstFunctionIntr(),
        "id": ConstFunctionIntr(),
        "int_": ConstFunctionIntr(type=lambda: md.TFun([[md.TLong(md.get_random_name()), md.TVar(md.get_random_name())]])),
        "iter": FunctionIntr(),  # not const
        "len": ConstFunctionIntr(return_range=prange.positive_values,
                                 type=lambda: md.TFun([[md.TLong(md.get_random_name()), md.TList(md.get_random_name(), md.TVar(md.get_random_name()))]])),
        "list": ClassWithReadOnceConstructor(CLASSES['list']),
        "long_": ConstFunctionIntr(),
        "map": ReadOnceFunctionIntr(type=lambda : [md.TFun(
            [[md.TList(md.get_random_name(), md.TVar(v)),
              md.TNone(),
              md.TIterable(md.get_random_name(), md.TVar(v))],
             [md.TList(md.get_random_name(), md.TTuple(md.get_random_name(), md.TVaArg())),
              md.TNone(),
              md.TVaArg(md.TIterable(md.get_random_name(), md.TVar("")))],
             [md.TList(md.get_random_name(), md.TVar(v)),
              md.TFun([[md.TVar(v), md.TVaArg()]]),
              md.TVaArg(md.TIterable(md.get_random_name(), md.TVar("")))],
             ]
        )
                                                    for v in [md.get_random_name()]][0]),
        "max": ReadOnceFunctionIntr(return_range=prange.max_values,
                                    type=lambda : md.TFun([[md.TCombine(md.get_random_name(), md.TVaArg()), md.TVaArg()]])),
        ...
        "range": ConstFunctionIntr(return_range_content=prange.range_values,
                                   type=lambda: md.TFun([[md.TList(md.get_random_name(), md.TLong),
        ...
        "sum": ReadOnceFunctionIntr(type=lambda: md.TFun([[md.TVar("tsum"), md.TIterable(md.get_random_name(), md.TVar("tsum"))]])),
        "tuple": ReadOnceFunctionIntr(),
        "xrange": ConstFunctionIntr(return_range_content=prange.range_values,
                                    type=lambda: md.TFun([[md.TIterable(md.get_random_name(), md.TLong(md.get_random_name())),
                                                           md.TLong(md.get_random_name()), md.TLong(md.get_random_name()),
                                                           md.TLong(md.get_random_name())],
                                                          [md.TIterable(md.get_random_name(), md.TLong(md.get_random_name())),
                                                           md.TLong(md.get_random_name()), md.TLong(md.get_random_name())],
                                                          [md.TIterable(md.get_random_name(), md.TLong(md.get_random_name())),
                                                           md.TLong(md.get_random_name())]])),
        "zip": ReadOnceFunctionIntr(type=lambda : md.TFun([[md.TList(md.get_random_name(), md.TTuple(md.get_random_name(), md.TVaArg())),
                                                            md.TVaArg(md.TIterable(md.get_random_name(), md.TVar("")))]])),
        "False": ConstantIntr(return_range=lambda args: prange.Range(0, 0)),
        "None": ConstantIntr(type=lambda: md.TNone()),
    ...
    "numpy": {
        ...
        "float_": ConstFunctionIntr(type=lambda: md.TFun([[md.TFloat(md.get_random_name()), md.TVar(md.get_random_name())]])),
        ...
        "square": ConstFunctionIntr(type=lambda: md.TFun([[md.TVar("__"), md.TVar("__")]])),
        "subtract": ConstFunctionIntr(),
        "sum": ConstMethodIntr(type=lambda: md.TFun([[md.TArray(md.get_random_name(), md.TLong), md.TLong]])),
        ...
        "zeros": ConstFunctionIntr(args=('shape', 'dtype'),
                                   defaults=("numpy.float64",),
                                   type=lambda: md.TFun([[md.TArray(md.get_random_name(), md.TLong),
                                                md.TTuple(md.TLong)]])),
    ...
    "functools": {
        "partial": FunctionIntr(type=lambda : md.TFun(md.TFun(md.TVaArg(id=1)), md.TFun(md.TVaArg(id=0), md.TVaArg(id=1)), md.TVaArg(id=0))),
        },
    "bisect": {
    ...
    "itertools": {
        ...
        "imap": ReadOnceFunctionIntr(type=lambda : [md.TFun(
            [[md.TIterable(md.get_random_name(), md.TVar(v)),
              md.TNone(),
              md.TIterable(md.get_random_name(), md.TVar(md.get_random_name()))],
             [md.TIterable(md.get_random_name(), md.TTuple(md.get_random_name(), md.TVaArg())),
              md.TNone(),
              md.TVaArg(md.TIterable(md.get_random_name(), md.TVar("")))],
             [md.TIterable(md.get_random_name(), md.TVar(v)),
              md.TFun([[md.TVar(v), md.TVaArg()]]),
    ...
    "__dispatch__": {
        ...
        "remove": MethodIntr(),
        "update": MethodIntr(update_effects,
                             type=lambda: md.TFun([[md.TNone(),
                                                  md.TDict(md.get_random_name(), md.TVar(md.get_random_name()), md.TVar(md.get_random_name())),
                                                  md.TList(md.get_random_name(), md.TTuple(md.TVar(md.get_random_name()), md.TVar(md.get_random_name())))]])),
        },
    }
