...
MODULES = {
    ...
    "numpy": {
        ...
        "bitwise_and": UFunc(BINARY_UFUNC),
        ...
        "greater": UFunc(BINARY_UFUNC),
        "greater_equal": UFunc(BINARY_UFUNC),
        ...
        "left_shift": UFunc(BINARY_UFUNC),
        "less": UFunc(BINARY_UFUNC),
        "less_equal": UFunc(BINARY_UFUNC),
        ...
        "logical_and": UFunc(BINARY_UFUNC),
        "logical_not": ConstFunctionIntr(),
        "logical_or": UFunc(BINARY_UFUNC),
        "logical_xor": UFunc(BINARY_UFUNC),
        "max": ConstMethodIntr(),
        "maximum": UFunc(BINARY_UFUNC),
        "mean": ConstMethodIntr(),
        "median": ConstFunctionIntr(),
        "min": ConstMethodIntr(),
        "minimum": UFunc(BINARY_UFUNC),
        "mod": UFunc(BINARY_UFUNC),
        "multiply": UFunc(BINARY_UFUNC),
        "nan": ConstantIntr(),
        ...
        "right_shift": UFunc(BINARY_UFUNC),
