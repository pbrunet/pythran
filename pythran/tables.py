...
MODULES = {
    "__builtin__": {
        ...
        "getattr": ConstFunctionIntr( type=md.TFun(md.TLong,
                                                   md.TArray("agnt", md.TLong), md.TLong)),
        ...
        "len": ConstFunctionIntr(return_range=prange.positive_values,
                                 type=md.TFun(md.TLong(), md.TList("name_len", md.TVar("tlen")))),
        "list": ClassWithReadOnceConstructor(CLASSES['list']),
        "long_": ConstFunctionIntr(),
        "map": ReadOnceFunctionIntr(type=md.TFun(md.TList("map_name", md.TVar("b")),
                                                 md.TFun(md.TVar("b"), md.TVaArg()),
                                                 md.TVaArg(md.TList("map_name2", md.TVar("c"))))),
        ...
        "range": ConstFunctionIntr(return_range_content=prange.range_values,
                                   type=md.TFun(md.TList("range_name", md.TLong),
        ...
        "xrange": ConstFunctionIntr(return_range_content=prange.range_values,
                                   type=md.TFun(md.TContainer("xrange_name", md.TLong),
                                                md.TLong, md.TLong, md.TLong)),
    ...
    "numpy": {
        ...
        "square": ConstFunctionIntr(type=md.TFun(md.TVar("__"), md.TVar("__"))),
        "subtract": ConstFunctionIntr(),
        "sum": ConstMethodIntr(type=md.TFun(md.TArray("sum_name", md.TLong), md.TLong)),
        ...
        "zeros": ConstFunctionIntr(args=('shape', 'dtype'),
                                   defaults=("numpy.float64",),
                                   type=md.TFun(md.TArray("zero_name", md.TLong),
                                                md.TTuple(md.TLong))),
    ...
    "__dispatch__": {
        ...
        "remove": MethodIntr(),
        "update": MethodIntr(update_effects,
                             type=md.TFun(md.TNone(),
                                          md.TDict("upd_name", md.TVar("tup"), md.TVar("tup2")),
                                          md.TList("up_name", md.TTuple(md.TVar("tup3"), md.TVar("tup4"))))),
        },
    }
