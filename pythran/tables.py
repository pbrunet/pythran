...
MODULES = {
    "__builtin__": {
        ...
        "map": ReadOnceFunctionIntr(type=md.TFun(md.TList(md.TVar("b")), md.TFun(md.TVar("b"), md.TVaArg()), md.TVaArg(md.TList(md.TVar("c"))))),
    ...
    "numpy": {
        ...
        "sum": ConstMethodIntr(type=md.TFun(md.TArray(md.TLong), md.TLong)),
