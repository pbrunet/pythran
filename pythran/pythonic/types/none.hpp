...
namespace pythonic
{
  ...
  namespace types
  {
    ...
    none<T, b>::none(Types &&args)
        : T(std::forward<Types>(args)), is_none(false)
    {
    }

    template <class T, bool b>
    bool none<T, b>::operator==(none_type const &) const
    {
      return is_none;
    }
    ...
    template <class T, bool b>
    template <class O>
    bool none<T, b>::operator==(O const &t) const
    {
      return not is_none and static_cast<T &>(*this) == t;
    }

    template <class T, bool b>
    none<T, b>::operator bool() const
    {
      return not is_none and static_cast<T &>(*this);
    }

    template <class T, bool b>
    intptr_t none<T, b>::id() const
    {
    ...
    template <class T>
    none<T, false>::none(T const &data)
    ...
    template <class T>
    none<T, false>::operator size_t() const
    {
      return data;
    }

    template <class T>
    none<T, false>::operator long() const
    {
      return data;
    }

    template <class T>
    none<T, false>::operator long long() const
    {
      return data;
    }

    template <class T>
    none<T, false>::operator double() const
    {
      return data;
    }

    template <class T>
    T &none<T, false>::operator=(T const &t)
    {
      is_none = false;
      return data = t;
    }
    ...
    template <class T>
    none<T, false> operator+(none<T, false> const &t0, none<T, false> const &t1)
    {
    ...
    template <class T>
    template <T t>
    none<T, false>::none(std::integral_constant<T, t> args)
        : data(t), is_none(false)
    {
    }
  }
}
