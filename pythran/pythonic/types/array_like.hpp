...
class ArrayLike
{
    public:
        ...
        // access interface
        virtual reference operator[](long i) = 0;
        virtual reference const operator[](long i) const = 0;
        virtual reference fast(long i) = 0;
        virtual reference const fast(long i) const = 0;
