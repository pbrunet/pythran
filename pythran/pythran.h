...
//    typedef core::indexed_ndarray<T,N> type;  // very conservative :-)
//};
//
template<class Op, class Arg0>
struct lazy<core::numpy_uexpr<Op,Arg0>>{
    typedef core::numpy_uexpr<Op,typename lazy<Arg0>::type> type;  // very conservative :-)
};

template<class Op, class Arg0, class Arg1>
struct lazy<core::numpy_expr<Op,Arg0,Arg1>>{
    typedef core::numpy_expr<Op,typename lazy<Arg0>::type, typename lazy<Arg1>::type> type;  // very conservative :-)
};
//
//template<class T, size_t N, size_t M>
//struct lazy<core::gsliced_ndarray<T,N,M>>{
//    typedef core::gsliced_ndarray<T,N,M> type;  // very conservative :-)
//};
//
template<class T>
